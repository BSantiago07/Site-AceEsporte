...
<body>
    ...
    <div class="mainCadastro">
        <?php
            ...
            $nome = $_GET['nome'];
            $qry = "SELECT * FROM atleta WHERE nome='$nome'";
        ...
        <form action="edit_Atleta.php" method="post">
            <div id="lin1">
                <label class="primeiroInput"> <p>Nome Completo</p> </label>
            ...
            <div id="lin4">
                ...
                <input type="text" id="clube" name="clube" value="<?php echo $row['clube']?>"  required>

                <label> <p>Quantidade de Patrocinadores</p> </label>
                <input type="number" id="qtdPatrocinador" name="qtde_patrocinador" value="<?php echo $row['qtde_patrocinador']?>"  required>
