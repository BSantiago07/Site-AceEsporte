        ...
        <div id="cardPerfil">
            <?php
                if(isset($_SESSION['senha']) && isset($_SESSION['nome'])){
                    ...
                    $sql="SELECT * FROM usuario WHERE senha = '$senha' AND nome = '$nome'";
            ...
            <ul>
                ...
                <li>
                    <p> <b>Usuário: </b> <?php echo $row["nome"]; ?></p>
                </li>
                <li>
            ...
            <div class="botaoPerfilAE">
                <div class="botao">
                    <p class="botaoExclusao">
                        <a href="amadorRemocao.php?nome=<?php echo $row["nome"];  ?>">
                            Excluir Perfil
                        </a>
                    </p>
                </div>
                ...
                <div class="botao">
                    <p class="botaoAlteracao">
                        <a href="amadorAlteracao.php?nome=<?php echo $row["nome"];  ?>">
                            Alterar Perfil
                        </a>
                    </p>
                </div>
