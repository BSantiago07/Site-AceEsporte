        ...
        <div id="cardPerfil">
            <?php
                if(isset($_SESSION['senha']) && isset($_SESSION['nome'])){
                    ...
                    $sql="SELECT * FROM patrocinador WHERE senha = '$senha' AND nome = '$nome'";
            ...
            <ul>
                <li>
                    <h2> <b> <?php echo $row["nome"]; ?> </b> </h2>
                </li>
                <li>
                    <p> <b> Nome da Empresa: </b><?php echo $row["nome_empresa"]; ?> </p>
                </li>
                <li>
            ...
            <div class="botaoPerfilAE">
                <div class="botao">
                    <p class="botaoExclusao">
                        <a href="patrocinadorRemocao.php?nome=<?php echo $row["nome"];  ?>">
                            Excluir Perfil
                        </a>
                    </p>
                </div>
                ...
                <div class="botao">
                    <p class="botaoAlteracao">
                        <a href="patrocinadorAlteracao.php?nome=<?php echo $row["nome"];  ?>">
                            Alterar Perfil
                        </a>
                    </p>
                </div>
